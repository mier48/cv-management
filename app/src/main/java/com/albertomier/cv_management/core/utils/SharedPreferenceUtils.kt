...
import com.albertomier.cv_management.CVManagementApp.Companion.getAppInstance
import com.albertomier.cv_management.core.utils.AppConstants.SHARED_NAME

class SharedPreferenceUtils {
    private val sharedPreferences: SharedPreferences =
        getAppInstance().getSharedPreferences(SHARED_NAME, Context.MODE_PRIVATE)
